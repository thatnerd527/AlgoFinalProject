...
class InternalCalculator {
    ...
    void ShowExpiredItems(WrappedWriter wW) {
    ...
    void ShowPurchasedItems(WrappedWriter wW) {
    ...
    void ShowSoldItems(WrappedWriter wW) {
    ...
    void ShowStolenItems(WrappedWriter wW) {
    ...
    void ShowBuiltItems(WrappedWriter wW) {
                    ...
                    while (true) {
                        ...
                        if (!findmat.isPresent()) {
                            ...
                            if (findmat.get().lifespanInSeconds > 0) {
                                ...
                                if (specifyStart) {
                                    Instant startLifespan = InventoryFunctions.
                                }
                ...
                case "2.3":
                    while (true) {
                        HashMap<String, String> result = new InputForm(wR, wW)
                                ...
                                .withField("Quantity", true)
                                .withTitle("Add sold item to record by ID")
                                .receiveInput();
                        Optional<Material> findmat = Server.currentlystored.materialsSub().stream()
                                .filter((Material mat) -> {
                        ...
                        if (!findmat.isPresent()) {
                            ...
                            sold.addMaterial(findmat.get().clone());
                            wW.write("Added material.\n");
                            break;
                        }
                ...
                case "2.4":
                    while (true) {
                        HashMap<String, String> result = new InputForm(wR, wW)
                                .withField("Material ID", true)
                                .withField("Quantity", true)
                                .withTitle("Add stolen item to record by ID")
                                .receiveInput();
                        Optional<Material> findmat = Server.currentlystored.materialsSub().stream()
                                .filter((Material mat) -> {
                                    return result.get("Material ID").equals(mat.MaterialID().toString());
                        ...
                        if (!findmat.isPresent()) {
                            ...
                            stolen.addMaterial(findmat.get().clone());
                            wW.write("Added material.\n");
                            break;
                        }
                ...
                case "2.5":
                    while (true) {
                        HashMap<String, String> result = new InputForm(wR, wW)
                                .withField("Template ID", true)
                                .withField("Quantity", true)
                                .withTitle("Add built item to record by ID")
                                .receiveInput();
                        Optional<Material> findmat = Server.templatematerials.materialsSub().stream()
                                .filter((Material mat) -> {
                                    return result.get("Template ID").equals(mat.MaterialID().toString());
                        ...
                        if (!findmat.isPresent()) {
                            ...
                            built.addMaterial(findmat.get().clone());
                            wW.write("Added material.\n");
                            break;
                        }
