    ...
    public void CalculatorUI(WrappedReader wR, WrappedWriter wW) {
        while (true) {
            String action = new Menu()
                    ...
                    .withChoice("1", "Show items that are expired")
                    .withChoice("2", "Show purchased items")
                    .withChoice("3", "Show sold items")
                    .withChoice("4", "Show stolen items")
                    .withChoice("5", "Show built items")
                    .withChoice("b", "Back")
