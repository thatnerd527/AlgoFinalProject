...
class InternalCalculator {
    ...
    // Get all of the materials that are required to build one unit of x, and if the material is not present in the current database then
    MaterialComposite getMaterialsForBuild
