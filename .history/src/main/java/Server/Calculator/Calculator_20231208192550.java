                        ...
                        x.getComposite().materials().forEach(x2 -> {
                            ...
                            if (materialinstock.isPresent()) {
                                ...
                                if (cloned_materialinstock.quantity >= x2.quantity) {
                                    ...
                                    sandbox.setCurrentValue(sandbox.getCurrentValue() - (cloned_materialinstock.quantity * cloned_materialinstock.valuePerQty));
                                    ...
                                    sandbox.setCurrentValue(sandbox.getCurrentValue() - (defficient * cloned_materialinstock.valuePerQty));
